      ...
      <div className="bg-gray-900 flex flex-col font-poppins items-center justify-start mx-auto p-[18px] w-full">
        <div className="flex flex-col md:gap-10 gap-40 items-center justify-start max-w-[1310px] mb-[54px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-center justify-start w-[99%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-[71px] w-full">
              ...
              <div className="flex flex-col relative w-[44%] md:w-full">
                <div className="md:h-[564px] sm:h-[644px] h-[734px] mx-auto w-full">
                ...
                <div className="flex flex-col gap-[33px] items-end justify-start ml-auto mr-[45px] mt-[-NaNpx] w-4/5 z-[1]">
                  <Img
                ...
                <div className="flex flex-col md:gap-10 gap-[116px] justify-start ml-auto mr-[15px] mt-[-24.79px] w-[23%] z-[1]">
                  <Img
                    className="h-5 md:ml-[0] ml-[100px]"
                    src="images/img_arrowright.svg"
                    alt="arrowright"
                  />
                  <a
                    href="javascript:"
                    className="mr-9 text-2xl md:text-[22px] text-blue_gray-100 sm:text-xl tracking-[-1.00px]"
                  >
                    <Text size="txtPoppinsSemiBold24">View all</Text>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col mt-[23px] relative w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[-73.21px] mx-auto w-full z-[1]">
                ...
                <div className="flex md:flex-1 flex-col md:gap-10 gap-[216px] justify-start md:ml-[0] ml-[380px] w-[12%] md:w-full">
                  <Img className="h-5" src="images/img_music.svg" alt="music" />
                  <Text
